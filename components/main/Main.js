...
import emailIcon from "../../public/png-transparent-email-marketing-icon-letter-m-angle-text-triangle.png";
...
const Main = () => {
  ...
  return (
    <div id="main" className={styles.container__layout}>
      {/* <div data-aos="fade-right" className={styles.contact}>
        <Image src={phoneIcon} height="30px" width="30px" layout="responsive" />
      </div> */}
